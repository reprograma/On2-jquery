...
$(function(){
  ...
  $(".increvase_area").prepend("<button class='inscrevaseBtn'>Inscreva-se</button>");
  /// APPEND botão no final da div - PREPEND botão no começo da div

  $(".btn-enviar").click(function(){
    $(".formulario").hide("slow");
    $(".increvase_area").append("<p>Seu formulário foi enviado</p>")
